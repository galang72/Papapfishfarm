...
export default function ReportsPage() {
  ...
  const handleExportExcel = () => {
    ...
    if (reportType === 'keuangan') {
      ...
      exportToExcel(rows, `Laporan_Keuangan_LeleFarm_${formatDateInput(new Date())}`);
      ...
      exportToExcel(rows, `Laporan_Budidaya_LeleFarm_${formatDateInput(new Date())}`);
      ...
      exportToExcel(rows, `Laporan_Panen_LeleFarm_${formatDateInput(new Date())}`);
    }
  };
